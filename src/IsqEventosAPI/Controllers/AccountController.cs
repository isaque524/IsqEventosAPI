...
namespace IsqEventosAPI.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetUser()
        {
            ...
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"Erro ao tentar recuperar Usuários. Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> Register(UserDto userDto)
        {
            ...
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"Erro ao tentar criar Usuários. Erro: {ex.Message}");
            }
        }
